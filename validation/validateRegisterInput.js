...
validateRegisterInput = async data => {
  ...
  // //validate email (React đã check rồi nên ko cần check lại)
  ...
  // //validate password (React đã check rồi nên ko cần check lại)
  ...
  // //validate password2 (React đã check rồi nên ko cần check lại)
  ...
  // // DOB (React đã check rồi nên ko cần check lại)
  ...
  // } else {
    ...
    if (phone) errors.phone = "Phone is already exist !";
  // }
